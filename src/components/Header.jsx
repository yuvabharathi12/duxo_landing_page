    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      {isOpen && (
        <>
          ...
          {/* Side Menu */}
          <div className="fixed top-0 right-0 h-screen w-64 max-w-[75vw] bg-gradient-to-br from-primary-50 to-secondary-50 z-[60] md:hidden animate-slide-in-right shadow-2xl border-l border-primary-300">
            <div className="flex flex-col h-full">
              {/* Header */}
              <div className="flex items-center p-4 border-b border-primary-300 bg-gradient-to-r from-primary-100 to-secondary-100">
                <span className="text-lg font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Menu</span>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  {['Capabilities', 'Pricing', 'Trust'].map((item, i) => (
                    <a
                      key={i}
                      href={`#${item.toLowerCase()}`}
                      className="px-3 py-3 text-base text-neutral-800 hover:text-primary-600 hover:bg-white font-semibold transition-all duration-200 rounded-lg touch-target"
              ...
              {/* CTA Button */}
              <div className="mt-auto p-4 border-t border-primary-300 bg-gradient-to-r from-primary-100 to-secondary-100">
                <button className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-bold text-base hover:shadow-xl hover:shadow-primary-500/30 transition-all duration-300 transform hover:scale-105 active:scale-95 touch-target">
                  Get Started
                </button>
              </div>
            </div>
